// All puzzles for Little Letter Griddle
...
export const completionMessages = [
  { phrase: "Très bien!", language: "French", pronunciation: "tray bee-EN" },
  { phrase: "¡Muy bien!", language: "Spanish", pronunciation: "moo-ee bee-EN" },
  { phrase: "Molto bene!", language: "Italian", pronunciation: "MOL-toh BEN-ay" },
  { phrase: "Sehr gut!", language: "German", pronunciation: "zair goot" },
  { phrase: "Muito bem!", language: "Portuguese", pronunciation: "MOO-ee-toh beng" },
  { phrase: "Heel goed!", language: "Dutch", pronunciation: "hayl khoot" },
  { phrase: "Mycket bra!", language: "Swedish", pronunciation: "MYK-et brah" },
  { phrase: "Maika'i!", language: "Hawaiian", pronunciation: "my-KAH-ee" },
  { phrase: "很好!", language: "Mandarin", pronunciation: "hun how" },
  { phrase: "Очень хорошо!", language: "Russian", pronunciation: "OH-chen ha-ra-SHOH" }
];

// Welcome messages (rotate daily)
...
// Get today's welcome message
export function getTodaysWelcomeMessage() {
  const puzzle = getTodaysPuzzle();
  return welcomeMessages[puzzle.puzzleNumber % welcomeMessages.length];
}

// Get today's completion message
export function getTodaysCompletionMessage() {
  const puzzle = getTodaysPuzzle();
  return completionMessages[puzzle.puzzleNumber % completionMessages.length];
}

// Moon phases for progression
export const moonPhases = [
  { icon: '🌑', name: 'New Moon', min: 0 },
  { icon: '🌒', name: 'Waxing Crescent', min: 10 },
  { icon: '🌓', name: 'First Quarter', min: 20 },
  { icon: '🌔', name: 'Waxing Gibbous', min: 30 },
  { icon: '🌕', name: 'Full Moon', min: 40 },
  { icon: '🌖', name: 'Waning Gibbous', min: 50 },
  { icon: '🌗', name: 'Last Quarter', min: 60 },
  { icon: '🌘', name: 'Waning Crescent', min: 70 },
  { icon: '✨', name: 'Radiant Moon', min: 80 }
];

// Get current moon phase based on puzzles completed
export function getCurrentMoonPhase(puzzlesCompleted) {
  for (let i = moonPhases.length - 1; i >= 0; i--) {
    if (puzzlesCompleted >= moonPhases[i].min) {
      return moonPhases[i];
    }
  }
  return moonPhases[0];
